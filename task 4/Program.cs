        ...
        while (true)
        {
            ...
            else if (commands[0] == "Kill")
            {
                for (int i = 0; i < footMan.Count; i++)
                {
                    ...
                    {
                        footMan[i].Panic();
                        if (footMan[i].isLive()) Console.WriteLine($"Footman {footMan[i].Name} is live!");
                        else
                        {
                ...
                for (int i = 0; i < royalGuards.Count; i++)
                {
                    ...
                    {
                        royalGuards[i].Defending();
                        if (royalGuards[i].isLive()) Console.WriteLine($"Royal guard {royalGuards[i].Name} is live!");
                        else
                        {
                            Console.WriteLine("He is dead :(");
